...
template<>
struct is_error_code_enum< dumbo::v1::fibers::future_errc > : public true_type {
};

inline
std::error_code make_error_code( dumbo::v1::fibers::future_errc e) noexcept {
    return std::error_code( static_cast< int >( e), dumbo::v1::fibers::future_category() );
}

inline
std::error_condition make_error_condition( dumbo::v1::fibers::future_errc e) noexcept {
    return std::error_condition( static_cast< int >( e), dumbo::v1::fibers::future_category() );
}
