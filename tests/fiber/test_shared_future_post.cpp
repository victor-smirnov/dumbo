...
void test_shared_future_wait_for() {
    ...
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::post, fn11, std::move( p1) ).detach();
...
void test_shared_future_wait_for_ref() {
    ...
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::post, fn12, std::move( p1) ).detach();
...
void test_shared_future_wait_for_void() {
    ...
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::post, fn13, std::move( p1) ).detach();
...
void test_shared_future_wait_with_fiber_1() {
    dumbo::v1::fibers::promise< int > p1;
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::post, fn1, & p1, 7).detach();
...
void test_shared_future_wait_with_fiber_2() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::post, fn2).join();
}
