...
void test_try_push_full() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.try_push( 1) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.try_push( 1) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::full == c.try_push( 2) );
}
...
void test_push_wait_for_timeout() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::timeout == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
}
...
void test_push_wait_until_timeout() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_until( 1,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::timeout == c.push_wait_until( 1,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_pop_success() {
    dumbo::v1::fibers::buffered_channel< int > c( 16);
    int v1 = 2, v2 = 0;
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::dispatch, [&c,&v2](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop( v2) );
    });
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::dispatch, [&c,v1](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    });
    f1.join();
    f2.join();
...
void test_pop_wait_for_timeout() {
    dumbo::v1::fibers::buffered_channel< int > c( 16);
    int v = 0;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, [&c,&v](){
...
void test_wm_1() {
    ...
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::dispatch, [&c,&ids](){
    ...
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::dispatch, [&c,&ids](){
        ids.push_back( dumbo::v1::this_fiber::get_id() );
...
void test_rangefor() {
    dumbo::v1::fibers::buffered_channel< int > chan{ 4 };
    std::vector< int > vec;
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::dispatch, [&chan]{
        chan.push( 1);
        chan.push( 1);
        chan.push( 2);
        chan.push( 3);
    ...
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::dispatch, [&vec,&chan]{
        for ( int value : chan) {
            vec.push_back( value);
        }
    });
