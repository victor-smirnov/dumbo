...
void fn2() {
    ...
    dumbo::v1::fibers::shared_future< int > f( p.get_future().share() );
    dumbo::v1::this_fiber::yield();
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fn1, & p, 7).detach();
    dumbo::v1::this_fiber::yield();
    BOOST_CHECK( 7 == f.get() );
}
...
void fn11( dumbo::v1::fibers::promise< int > p) {
  dumbo::v1::this_fiber::sleep_for( ms(500) );
  p.set_value(3);
}

void fn12( dumbo::v1::fibers::promise< int& > p) {
  dumbo::v1::this_fiber::sleep_for( ms(500) );
  gi = 5;
  p.set_value( gi);
}

void fn13( dumbo::v1::fibers::promise< void > p) {
  dumbo::v1::this_fiber::sleep_for( ms(500) );
  p.set_value();
}
...
void test_shared_future_create() {
    {
        ...
        dumbo::v1::fibers::shared_future< int > f1;
        dumbo::v1::fibers::shared_future< int > f2 = f1;
...

    {
        ...
        dumbo::v1::fibers::promise< int > p;
        dumbo::v1::fibers::shared_future< int > f1 = p.get_future();
        dumbo::v1::fibers::shared_future< int > f2 = f1;
        BOOST_CHECK( f1.valid() );
        BOOST_CHECK( f2.valid() );
    }
...
void test_shared_future_create_void() {
    {
        // default constructed and assigned shared_future is not valid
        dumbo::v1::fibers::shared_future< void > f1;
        dumbo::v1::fibers::shared_future< void > f2 = f1;
        BOOST_CHECK( ! f1.valid() );
        BOOST_CHECK( ! f2.valid() );
    }
    ...
    {
        // shared_future retrieved from promise is valid
        dumbo::v1::fibers::promise< void > p;
        dumbo::v1::fibers::shared_future< void > f1 = p.get_future();
        dumbo::v1::fibers::shared_future< void > f2 = f1;
        BOOST_CHECK( f1.valid() );
        BOOST_CHECK( f2.valid() );
    }
...
void test_shared_future_get() {
    ...
    dumbo::v1::fibers::promise< int > p1;
    p1.set_value( 7);

    dumbo::v1::fibers::shared_future< int > f1 = p1.get_future().share();
    BOOST_CHECK( f1.valid() );
    ...
    {
        dumbo::v1::fibers::promise< int > p2;
        f1 = p2.get_future().share();
    }
    bool thrown = false;
    try {
        f1.get();
    } catch ( dumbo::v1::fibers::broken_promise const&) {
        thrown = true;
    }
    BOOST_CHECK( f1.valid() );
    BOOST_CHECK( thrown);
...
void test_shared_future_get_move() {
    // future retrieved from promise is valid (if it is the first)
    dumbo::v1::fibers::promise< A > p1;
    A a; a.value = 7;
    p1.set_value( std::move( a) );

    dumbo::v1::fibers::shared_future< A > f1 = p1.get_future().share();
    BOOST_CHECK( f1.valid() );
...
void test_shared_future_get_void() {
    // future retrieved from promise is valid (if it is the first)
    dumbo::v1::fibers::promise< void > p1;
    p1.set_value();

    dumbo::v1::fibers::shared_future< void > f1 = p1.get_future().share();
    BOOST_CHECK( f1.valid() );
    ...
    // throw broken_promise if promise is destroyed without set
    {
        dumbo::v1::fibers::promise< void > p2;
        f1 = p2.get_future().share();
    }
    bool thrown = false;
    try {
...
void test_future_share() {
    ...
    dumbo::v1::fibers::future< int > f1 = p1.get_future();
    BOOST_CHECK( f1.valid() );

    // share
    dumbo::v1::fibers::shared_future< int > sf1 = f1.share();
...
void test_future_share_void() {
    ...
    dumbo::v1::fibers::future< void > f1 = p1.get_future();
    BOOST_CHECK( f1.valid() );

    // share
    dumbo::v1::fibers::shared_future< void > sf1 = f1.share();
    BOOST_CHECK( sf1.valid() );
    BOOST_CHECK( ! f1.valid() );
...
void test_shared_future_wait_for() {
    ...
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fn11, std::move( p1) ).detach();

    // wait on future
    BOOST_CHECK( f1.valid() );
    dumbo::v1::fibers::future_status status = f1.wait_for( ms(300) );
    BOOST_CHECK( dumbo::v1::fibers::future_status::timeout == status);

    BOOST_CHECK( f1.valid() );
    status = f1.wait_for( ms(300) );
    BOOST_CHECK( dumbo::v1::fibers::future_status::ready == status);
...
void test_shared_future_wait_for_ref() {
    ...
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fn12, std::move( p1) ).detach();
...
void test_shared_future_wait_for_void() {
    ...
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fn13, std::move( p1) ).detach();
...
void test_shared_future_wait_until() {
    ...
    // wait on future
    BOOST_CHECK( f1.valid() );
    dumbo::v1::fibers::future_status status = f1.wait_until( Clock::now() + ms(300) );
    BOOST_CHECK( dumbo::v1::fibers::future_status::timeout == status);
...
void test_shared_future_wait_with_fiber_1() {
    dumbo::v1::fibers::promise< int > p1;
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fn1, & p1, 7).detach();
...
void test_shared_future_wait_with_fiber_2() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fn2).join();
}
...
void test_shared_future_move() {
    ...
    // move construction
    dumbo::v1::fibers::shared_future< int > f2( std::move( f1) );
    BOOST_CHECK( ! f1.valid() );
    BOOST_CHECK( f2.valid() );
...
void test_shared_future_move_move() {
    ...
    // move construction
    dumbo::v1::fibers::shared_future< A > f2( std::move( f1) );
    BOOST_CHECK( ! f1.valid() );
    BOOST_CHECK( f2.valid() );
...
void test_shared_future_move_void() {
    ...
    // move construction
    dumbo::v1::fibers::shared_future< void > f2( std::move( f1) );
    BOOST_CHECK( ! f1.valid() );
    BOOST_CHECK( f2.valid() );
