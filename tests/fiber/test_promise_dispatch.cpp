...
void test_promise_create() {
    ...
    std::allocator< dumbo::v1::fibers::promise< int > > alloc;
    dumbo::v1::fibers::promise< int > p2( std::allocator_arg,  alloc);
}
...
void test_promise_create_void() {
    ...
    // use std::allocator<> as user defined
    std::allocator< dumbo::v1::fibers::promise< void > > alloc;
    dumbo::v1::fibers::promise< void > p2( std::allocator_arg, alloc);
}
...
void test_promise_move() {
    ...
    // move construction
    dumbo::v1::fibers::promise< int > p2( std::move( p1) );
...
void test_promise_move_void() {
    ...
    // move construction
    dumbo::v1::fibers::promise< void > p2( std::move( p1) );
...
void test_promise_get_future() {
    ...
    try {
        f1 = p1.get_future();
    } catch ( dumbo::v1::fibers::promise_uninitialized const&) {
        thrown = true;
    }
    BOOST_CHECK( thrown);
}
