...
struct test_exclusive {
    ...
    void operator()() {
        ...
        mutex_type mtx;
        dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::dispatch, & fn1< mutex_type >, std::ref( mtx) );
        dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::dispatch, & fn2< mutex_type >, std::ref( mtx) );
...
void do_test_mutex() {
...

    {
        ...
        mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn17, std::ref( mtx) );
...

    {
        dumbo::v1::fibers::mutex mtx;
        mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn18, std::ref( mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        mtx.unlock();
        f.join();
    }
...
void test_mutex() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, & do_test_mutex).join();
}
...
void do_test_recursive_mutex() {
...

    {
        ...
        mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn15, std::ref( mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::recursive_mutex mtx;
        mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn16, std::ref( mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        mtx.unlock();
        f.join();
    }
...
void test_recursive_mutex() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, do_test_recursive_mutex).join();
}
...
void do_test_timed_mutex() {
...

    {
        ...
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn3, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn4, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn5, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn6, std::ref( timed_mtx) );
...

    {
        dumbo::v1::fibers::timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn7, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn8, std::ref( timed_mtx) );
...
void test_timed_mutex() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, & do_test_timed_mutex).join();
}
...
void do_test_recursive_timed_mutex() {
...

    {
        ...
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn9, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::recursive_timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn10, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::recursive_timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn11, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::recursive_timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn12, std::ref( timed_mtx) );
...

    {
        dumbo::v1::fibers::recursive_timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn13, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(250) );
        timed_mtx.unlock();
        f.join();
    }

    {
        dumbo::v1::fibers::recursive_timed_mutex timed_mtx;
        timed_mtx.lock();
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, & fn14, std::ref( timed_mtx) );
        dumbo::v1::this_fiber::sleep_for( ms(300) );
        timed_mtx.unlock();
        f.join();
    }
...
void test_recursive_timed_mutex() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, & do_test_recursive_timed_mutex).join();
}
