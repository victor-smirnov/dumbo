...
void test_zero_wm() {
    bool thrown = false;
    try {
        dumbo::v1::fibers::buffered_channel< int > c( 0);
    } catch ( dumbo::v1::fibers::fiber_error const&) {
        thrown = true;
    }
    BOOST_CHECK( thrown);
}
...
void test_push() {
    dumbo::v1::fibers::buffered_channel< int > c( 16);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 1) );
}

void test_push_closed() {
    dumbo::v1::fibers::buffered_channel< int > c( 16);
    c.close();
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.push( 1) );
}

void test_try_push() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 1) );
}

void test_try_push_closed() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.try_push( 1) );
    c.close();
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.try_push( 2) );
}

void test_try_push_full() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.try_push( 1) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.try_push( 2) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::full == c.try_push( 3) );
}

void test_push_wait_for() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
}

void test_push_wait_for_closed() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    c.close();
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
}

void test_push_wait_for_timeout() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_for( 2, std::chrono::seconds( 1) ) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::timeout == c.push_wait_for( 3, std::chrono::seconds( 1) ) );
}

void test_push_wait_until() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_until( 1,
...
void test_push_wait_until_closed() {
    dumbo::v1::fibers::buffered_channel< int > c( 2);
    c.close();
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.push_wait_until( 1,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_push_wait_until_timeout() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_until( 1,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push_wait_until( 2,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::timeout == c.push_wait_until( 3,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_pop() {
    dumbo::v1::fibers::buffered_channel< int > c( 16);
    int v1 = 2, v2 = 0;
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop( v2) );
...
void test_pop_closed() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop( v2) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.pop( v2) );
}

void test_pop_success() {
    dumbo::v1::fibers::buffered_channel< int > c( 16);
    int v1 = 2, v2 = 0;
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::post, [&c,&v2](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop( v2) );
    });
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::post, [&c,v1](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    });
    f1.join();
    f2.join();
...
void test_try_pop() {
    ...
    int v1 = 2, v2 = 0;
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.try_pop( v2) );
    BOOST_CHECK_EQUAL( v1, v2);
}
...
void test_try_pop_closed() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.try_pop( v2) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.try_pop( v2) );
}
...
void test_try_pop_success() {
    ...
    int v1 = 2, v2 = 0;
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::post, [&c,&v2](){
        while ( dumbo::v1::fibers::channel_op_status::success != c.try_pop( v2) ) {
...
void test_pop_wait_for() {
    ...
    int v1 = 2, v2 = 0;
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop_wait_for( v2, std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
}
...
void test_pop_wait_for_closed() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop_wait_for( v2, std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.pop_wait_for( v2, std::chrono::seconds( 1) ) );
}
...
void test_pop_wait_for_timeout() {
    dumbo::v1::fibers::buffered_channel< int > c( 16);
    int v = 0;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::post, [&c,&v](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::timeout == c.pop_wait_for( v, std::chrono::seconds( 1) ) );
    });
    f.join();
}
...
void test_pop_wait_until() {
    ...
    int v1 = 2, v2 = 0;
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop_wait_until( v2,
            std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
}
...
void test_pop_wait_until_closed() {
    ...
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop_wait_until( v2,
            std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::closed == c.pop_wait_until( v2,
            std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_pop_wait_until_timeout() {
    ...
    int v = 0;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::post, [&c,&v](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::timeout == c.pop_wait_until( v,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    });
    f.join();
}
...
void test_wm_1() {
    dumbo::v1::fibers::buffered_channel< int > c( 4);
    std::vector< dumbo::v1::fibers::fiber::id > ids;
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::post, [&c,&ids](){
        ids.push_back( dumbo::v1::this_fiber::get_id() );
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 1) );

        ids.push_back( dumbo::v1::this_fiber::get_id() );
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 2) );

        ids.push_back( dumbo::v1::this_fiber::get_id() );
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 3) );

        ids.push_back( dumbo::v1::this_fiber::get_id() );
        // would be blocked because channel is full
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 4) );

        ids.push_back( dumbo::v1::this_fiber::get_id() );
        // would be blocked because channel is full
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 5) );

        ids.push_back( dumbo::v1::this_fiber::get_id() );
    });
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::post, [&c,&ids](){
        ids.push_back( dumbo::v1::this_fiber::get_id() );
    ...
    dumbo::v1::fibers::fiber::id id1 = f1.get_id();
    dumbo::v1::fibers::fiber::id id2 = f2.get_id();
    f1.join();
    f2.join();
...
void test_wm_2() {
    dumbo::v1::fibers::buffered_channel< int > c( 8);
    std::vector< dumbo::v1::fibers::fiber::id > ids;
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::post, [&c,&ids](){
        ids.push_back( dumbo::v1::this_fiber::get_id() );
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 1) );
...
void test_moveable() {
    dumbo::v1::fibers::buffered_channel< moveable > c( 16);
    moveable m1( 3), m2;
    BOOST_CHECK( m1.state);
    BOOST_CHECK_EQUAL( 3, m1.value);
    BOOST_CHECK( ! m2.state);
    BOOST_CHECK_EQUAL( -1, m2.value);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( std::move( m1) ) );
    BOOST_CHECK( ! m1.state);
    BOOST_CHECK( ! m2.state);
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop( m2) );
    BOOST_CHECK( ! m1.state);
...
void test_rangefor() {
    dumbo::v1::fibers::buffered_channel< int > chan{ 2 };
    std::vector< int > vec;
    dumbo::v1::fibers::fiber f1([&chan]{
        chan.push( 1);
        chan.push( 1);
        chan.push( 2);
        chan.push( 3);
    ...
    dumbo::v1::fibers::fiber f2([&vec,&chan]{
        for ( int value : chan) {
            vec.push_back( value);
        }
    });
