...
void fss() {
    ...
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::dispatch, fss_fiber);
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::dispatch, fss_fiber);
    dumbo::v1::fibers::fiber f3( dumbo::v1::fibers::launch::dispatch, fss_fiber);
    dumbo::v1::fibers::fiber f4( dumbo::v1::fibers::launch::dispatch, fss_fiber);
    dumbo::v1::fibers::fiber f5( dumbo::v1::fibers::launch::dispatch, fss_fiber);
    f1.join();
    f2.join();
    f3.join();
    f4.join();
...
void test_fss() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fss).join();
}
...
void fss_with_custom_cleanup() {
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, fss_fiber_with_custom_cleanup);
    try {
        f.join();
    } catch(...) {
        f.join();
...
void test_fss_with_custom_cleanup() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fss_with_custom_cleanup).join();
}
...
void do_test_fss_does_no_cleanup_after_release() {
    ...
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, fss_fiber_with_custom_cleanup_and_release);
    try {
        f.join();
    } catch(...) {
        f.join();
...
void do_test_fss_does_no_cleanup_with_null_cleanup_function() {
    ...
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, [&delete_tracker](){
...
void test_fss_does_no_cleanup_after_release() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, do_test_fss_does_no_cleanup_after_release).join();
}

void test_fss_does_no_cleanup_with_null_cleanup_function() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, do_test_fss_does_no_cleanup_with_null_cleanup_function).join();
}
...
void fss_does_not_call_cleanup_after_ptr_destroyed() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fiber_with_local_fss_ptr).join();
    BOOST_CHECK(!fss_cleanup_called);
}

void test_fss_does_not_call_cleanup_after_ptr_destroyed() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fss_does_not_call_cleanup_after_ptr_destroyed).join();
}
...
void test_fss_cleanup_not_called_for_null_pointer() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fss_cleanup_not_called_for_null_pointer).join();
}
...
void test_fss_at_the_same_adress() {
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, fss_at_the_same_adress).join();
}
