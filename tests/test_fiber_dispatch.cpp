...
void fn5() {
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, fn4);
...
void test_join_fn() {
    {
        value1 = 0;
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, fn1);
        f.join();
    ...
    }
    {
        value1 = 0;
        value2 = "";
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, fn2, 3, "abc");
        f.join();
...
void test_join_memfn() {
    ...
    dumbo::v1::fibers::fiber( dumbo::v1::fibers::launch::dispatch, & X::foo, std::ref( x), 3).join();
...
void test_join_copyable() {
    ...
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, cp);
    f.join();
    BOOST_CHECK( cp.state);
    BOOST_CHECK_EQUAL( value1, 3);
}
...
void test_join_moveable() {
    ...
    BOOST_CHECK_EQUAL( value1, 0);
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, std::move( mv) );
    f.join();
    BOOST_CHECK( ! mv.state);
...
void test_join_lambda() {
    {
        ...
        int i = 3;
        std::string abc("abc");
        dumbo::v1::fibers::fiber f(
                dumbo::v1::fibers::launch::dispatch, [i,abc]() {
                    value1 = i;
                    value2 = abc;
                });
        f.join();
    ...
    }
    {
        ...
        std::string abc("abc");
        dumbo::v1::fibers::fiber f(
                dumbo::v1::fibers::launch::dispatch, [](int i, std::string const& abc) {
                    value1 = i;
                    value2 = abc;
                },
                i, abc);
...
void test_join_bind() {
    {
        ...
        std::string abc("abc");
        dumbo::v1::fibers::fiber f(
            dumbo::v1::fibers::launch::dispatch, std::bind(
                [i,abc]() {
                    value1 = i;
                    value2 = abc;
                }
...
void test_join_in_fiber() {
    ...
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, fn5);
    BOOST_CHECK( f.joinable() );
...
void test_move_fiber() {
    ...
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::dispatch, fn1);
...
void test_id() {
    ...
    BOOST_CHECK_EQUAL( dumbo::v1::fibers::fiber::id(), f1.get_id() );
    BOOST_CHECK( dumbo::v1::fibers::fiber::id() != f2.get_id() );

    dumbo::v1::fibers::fiber f3( dumbo::v1::fibers::launch::dispatch, fn1);
    ...
    BOOST_CHECK( dumbo::v1::fibers::fiber::id() != f1.get_id() );
    BOOST_CHECK_EQUAL( dumbo::v1::fibers::fiber::id(), f2.get_id() );
...
void test_yield() {
    ...
    dumbo::v1::fibers::fiber f1( dumbo::v1::fibers::launch::dispatch, fn3, std::ref( v1) );
    dumbo::v1::fibers::fiber f2( dumbo::v1::fibers::launch::dispatch, fn3, std::ref( v2) );
    f1.join();
    f2.join();
    BOOST_CHECK( ! f1.joinable() );
    BOOST_CHECK( ! f2.joinable() );
...
void test_sleep_for() {
    ...
    dumbo::v1::this_fiber::sleep_for(ms);
...
void test_sleep_until() {
    {
        ...
        std::chrono::milliseconds ms(500);
        time_point t0 = Clock::now();
        dumbo::v1::this_fiber::sleep_until(t0 + ms);
        time_point t1 = Clock::now();
        std::chrono::nanoseconds ns = (t1 - t0) - ms;
        std::chrono::nanoseconds err = ms / 100;
        // The time slept is within 1% of 500ms
...
void do_wait( dumbo::v1::fibers::barrier* b) {
    b->wait();
}

void test_detach() {
    {
        dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, (detachable()) );
        BOOST_CHECK( f.joinable() );
        f.detach();
        BOOST_CHECK( ! f.joinable() );
        dumbo::v1::this_fiber::sleep_for( std::chrono::milliseconds(250) );
