...
void test_push() {
    dumbo::v1::fibers::unbuffered_channel< int > c;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, [&c](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( 1) );
    });
    int value = 0;
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop( value) );
...
void test_pop() {
    dumbo::v1::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, [&v1,&c](){
...
void test_pop_success() {
    dumbo::v1::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, [&c,&v2](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.pop( v2) );
    });
    BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    f.join();
...
void test_value_pop() {
    dumbo::v1::fibers::unbuffered_channel< int > c;
    int v1 = 2, v2 = 0;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, [&c,&v1](){
        BOOST_CHECK( dumbo::v1::fibers::channel_op_status::success == c.push( v1) );
    });
    v2 = c.value_pop();
    f.join();
...
void test_pop_wait_until_timeout() {
    ...
    int v = 0;
    BOOST_CHECK(
            dumbo::v1::fibers::channel_op_status::timeout == c.pop_wait_until( v,
                std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_moveable() {
    dumbo::v1::fibers::unbuffered_channel< moveable > c;
    dumbo::v1::fibers::fiber f( dumbo::v1::fibers::launch::dispatch, [&c]{
        moveable m1( 3);
...
void test_rangefor() {
    dumbo::v1::fibers::unbuffered_channel< int > chan;
    std::vector< int > vec;
